...
public class MyEmail {
	 ...
	 * 默认的构造方法，拥有默认的配置
	 */
	public MyEmail(String user, String password) throws GeneralSecurityException, NoSuchProviderException {
		this.user = user;
	 ...
	 * @throws NoSuchProviderException
	 */
	public MyEmail(Properties props, String user ,String password) throws NoSuchProviderException {
		this.user = user;
		this.password = password;
		this.props = props;
		session = Session.getInstance(props,   
